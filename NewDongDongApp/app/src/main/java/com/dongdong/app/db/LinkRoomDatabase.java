...
public class LinkRoomDatabase {
	private final DatabaseHelper dbHelper;

	public LinkRoomDatabase(Context context) {
		super();
	...
	// SQLiteDatabase sqlite = dbHelper.getWritableDatabase();
	// String sql = ("delete from " + DatabaseHelper.NOTE_TABLE_NAME +
	// " where _id=?");
	...
	// SQLiteDatabase sqlite = dbHelper.getWritableDatabase();
	// String sql = ("update " + DatabaseHelper.NOTE_TABLE_NAME +
	// " set iid=?, time=?, date=?, content=?, color=? where _id=?");
	// sqlite.execSQL(sql,
