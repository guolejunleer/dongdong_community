...
public class CommonPhoneActivity extends BaseActivity implements
	...
	private List<PhoneBean> mStrList = new ArrayList<PhoneBean>();
	...
	public void initView() {
		...
		mTitleBar.setTitleBarContent(getString(R.string.phone));
		mTitleBar.setOnTitleBarClickListener(this);
		mTitleBar.setAddArrowShowing(false);

		mGridView = (GridView) this.findViewById(R.id.grid_view1);
	...
	private void call(int position) {
		mCommonPhone = mStrList.get(position);
		mtel = mCommonPhone.getCommonphone();
