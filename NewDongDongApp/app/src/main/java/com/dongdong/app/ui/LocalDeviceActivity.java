...
public class LocalDeviceActivity extends BaseActivity implements
    ...
    protected void onResume() {
        ...
        mTvWifiName.setText(String.format("%s","wifi   " + getWifiName()));
    ...
    private OnItemClickListener mListItemClick = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
            ...
            TextView login = (TextView) diaView.findViewById(R.id.tv_login);
            TextView cancel = (TextView) diaView.findViewById(R.id.tv_cancel);
            ...
            login.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    tipTextView.setText(getString(R.string.waiting_connection_30));
